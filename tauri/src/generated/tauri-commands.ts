...
export type Outline = { id: string; parentId: string | null; findex: string; type: OutlineType; doc: string; linklist: LinkList; createdAt: number; updatedAt: number; completed: SqliteBool; collapsed: SqliteBool }
